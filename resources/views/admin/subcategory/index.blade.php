...
<section class="content">
    ...
    <div class="col-md-9">
    <a class="btn btn-app bg-green" href="{{ Route('subcategory.create') }}">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست  زیرگروه ها</h3>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btn bg-blue" href="{{ route('subcategory.edit',['subcategory'=>$subcategory->id]) }}" >
