...
<section class="content">
    ...
    <div class="col-md-9">
    <a class="btn btn-app bg-green" href="{{ Route('permission.create') }}">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $permission->id }}</td>
                                <td><a  href="{{ route('permission.show',['permission'=>$permission->id]) }}">{{ $permission->name }}</a>
                                </td>
                                <td>{{ $permission->title }}</td>

                   
                                <td>
                                <a class="btn bg-blue" href="{{ route('permission.edit',['permission'=>$permission->id]) }}" >
