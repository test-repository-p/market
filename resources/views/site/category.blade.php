    ...
    <div class="row products-category">
        ...
        <div class="product-layout product-list col-xs-12">
            <div class="product-thumb">
                <div class="image">
                    <a href="{{ url('site/element/'.$item->id) }}"><img src="/{{ $item->photos()->first()->path }} " alt=" {{ $item->title }}  "
                            title=" {{ $item->title }}  " class="img-responsive" /></a>
                </div>
                <div>
                    <div class="caption">
                        <h4><a href="{{ url('site/element/'.$item->id) }}">{{ $item->title }} </a></h4>
                        <p class="description">
                    ...
                    <div class="button-group">
                        ...
                        <div class="add-to-links">
                            <button type="button" data-toggle="tooltip" title="افزودن به علاقه مندی ها" onClick=""><i
                                    class="fa fa-heart"></i> <span>افزودن به علاقه مندی ها</span></button>
                            <button type="button" data-toggle="tooltip" title="مقایسه این محصول" onClick=""><i
                                    class="fa fa-exchange"></i> <span>مقایسه این محصول</span></button>
                        </div>
                    </div>
                </div>
            </div>
